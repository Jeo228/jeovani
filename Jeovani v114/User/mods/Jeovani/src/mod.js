...
class Jeovani {
    ...
    postDBLoad(container) {
        ...
        this.addTraderToLocales(tables, baseJson.name, "Jeovani", baseJson.nickname, baseJson.location, "Under the guise of an armorer outfitting USEC renegades, Captain Jacob 'Jeovani' Carter is a CIA Asset ready to utilise your PMC for the farm's purposes");
