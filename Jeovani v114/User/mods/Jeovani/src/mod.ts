...
class Jeovani {
    constructor() {
        this.mod = "Jeovani"; // Set name of mod so we can log it to console later
    }
    /**
    ...
    postDBLoad(container) {
        ...
        this.addTraderToLocales(tables, baseJson.name, "Jeovani", baseJson.nickname, baseJson.location, "Description": "Under the guise of an armorer named Jeovani who outfits USEC renegades, Captain Jacob Carter is a CIA Asset ready to utilise your PMC for the farm's purposes");
    ...
    registerProfileImage(preAkiModLoader, imageRouter) {
        ...
        imageRouter.addRoute(baseJson.avatar.replace(".jpg", ""), `${imageFilepath}/jeovani1.jpg`);
    }
    /**
...
module.exports = { mod: new Jeovani() };
